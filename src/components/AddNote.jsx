...
const AddNote = () => {
    ...
    return (
        <div className="container my-3">
            <h2 className='ad' style={{color:"white"}}>Add a Note</h2>
            <form className="my-3">
                <div className="mb-3">
                ...
                <button disabled={note.title.length<5 || note.description.length<5} type="submit" className="btn"style={{color:"white",backgroundColor:"#0a50f5"}} onClick={handleClick}>Add Note</button>
            </form>
        </div>
    )
}
